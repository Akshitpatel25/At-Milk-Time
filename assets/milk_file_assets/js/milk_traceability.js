...
document.addEventListener("DOMContentLoaded", function () {
  ...
  let milk_traceability = document.querySelector(".milk_traceability");
  
  window.addEventListener("load", () => {
    setTimeout(() => {
      preloader.style.display = "none";
      milk_traceability.style.display = "flex";
    }, 1500);
  });
  ...
  image_container.addEventListener("click", () => {
    window.location.href = "/assets/milk_file_assets/html/milk_collection.html";
  });
