...
let animal_welfare = document.querySelector(".animal_welfare");

window.addEventListener("load", () => {
  setTimeout(() => {
    preloader.style.display = "none";
    animal_welfare.style.display = "flex";
  }, 1500);
});
...
let secondd_section = document.querySelector(".secondd_section");
let first_section_second_part = document.querySelector(
  ".first_section_second_part"
);
let image_container = document.querySelector(".image-container");
let section_middlee = document.querySelector(".section_middlee");
let second_section_middle = document.querySelector(".second_section_middle");
...
hamburger_box.addEventListener("click", () => {
  ...
  secondd_section.classList.toggle("secondd_section--open");
  first_section_second_part.classList.toggle("first_section_second_part--open");
  image_container.classList.toggle("image-container--open");
  section_middlee.classList.toggle("section_middlee--open");
  second_section_middle.classList.toggle("second_section_middle--open");
});
...
image_container.addEventListener("click", () => {
  window.location.href = "/assets/milk_file_assets/html/best_practice.html";
});
