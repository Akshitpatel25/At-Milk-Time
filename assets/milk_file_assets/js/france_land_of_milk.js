...
let france_land = document.querySelector(".france_land");

window.addEventListener("load", () => {
  setTimeout(() => {
    preloader.style.display = "none";
    france_land.style.display = "flex";
  }, 1500);
});
...
function changewidth() {
  let scroll = window.pageYOffset / 16;
...
image_container.addEventListener("click", () => {
  window.location.href = "/assets/milk_file_assets/html/franch_dairy_farm.html";
});
