...
document.addEventListener("DOMContentLoaded", function () {
  ...
  let best_practice = document.querySelector(".best_practice");
  
  window.addEventListener("load", () => {
    setTimeout(() => {
      preloader.style.display = "none";
      best_practice.style.display = "flex";
    }, 1500);
  });
  ...
  function changewidth() {
    let scroll = window.pageYOffset / 33;
  ...
  image_container.addEventListener("click", () => {
    window.location.href = "animal_health.html";
  });
