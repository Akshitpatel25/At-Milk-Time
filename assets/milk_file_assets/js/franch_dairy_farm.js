...
document.addEventListener("DOMContentLoaded", function () {
  ...
  let franch_dairy_farm = document.querySelector(".franch_dairy_farm");
  
  window.addEventListener("load", () => {
    setTimeout(() => {
      preloader.style.display = "none";
      franch_dairy_farm.style.display = "flex";
    }, 1500);
  });
  ...
  image_container.addEventListener("click", () => {
    window.location.href = "/assets/milk_file_assets/html/franch_dairy_cow.html";
  });
