...
document.addEventListener("DOMContentLoaded", function () {
  ...
  let franch_dairy_cow = document.querySelector(".franch_dairy_cow");
  
  window.addEventListener("load", () => {
    setTimeout(() => {
      preloader.style.display = "none";
      franch_dairy_cow.style.display = "flex";
    }, 1500);
  });
  ...
  image_container.addEventListener("click", () => {
    window.location.href = "/assets/inside_html_file/the_milking.html";
  });
