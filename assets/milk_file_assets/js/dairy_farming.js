...
document.addEventListener("DOMContentLoaded", function () {
  ...
  let dairy_farming = document.querySelector(".dairy_farming");
  
  window.addEventListener("load", () => {
    setTimeout(() => {
      preloader.style.display = "none";
      dairy_farming.style.display = "flex";
    }, 1500);
  });
  ...
  image_container.addEventListener("click", () => {
    window.location.href = "/assets/milk_file_assets/html/animal_welfare.html";
  });
