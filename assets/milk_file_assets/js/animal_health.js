...
document.addEventListener("DOMContentLoaded", function () {
  ...
  let animal_health = document.querySelector(".animal_health");
  
  window.addEventListener("load", () => {
    setTimeout(() => {
      preloader.style.display = "none";
      animal_health.style.display = "flex";
    }, 1500);
  });
  ...
  let change_section = document.querySelector(".change_section");
  let section_middle = document.querySelector(".section_middle");
  ...
  hamburger_box.addEventListener("click", () => {
    ...
    change_section.classList.toggle("change_section--open");
    section_middle.classList.toggle("section_middle--open");
  });
  ...
  function changewidth() {
    let scroll = window.pageYOffset / 60;
    let width = Math.min(50 - scroll);
  ...
  image_container.addEventListener("click", () => {
    window.location.href = "/assets/milk_file_assets/html/milk_traceability.html";
  });
