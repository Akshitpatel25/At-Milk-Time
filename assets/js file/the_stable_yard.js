...
window.addEventListener("load", () => {
  setTimeout(() => {
    ...
    the_stable_yard.style.display = "flex";
  }, 1500);
});
...
image_container.addEventListener("click", () => {
  window.location.href = "the_natural_en.html";
});
...
center_part_bottom_btn.addEventListener("click", () => {
  let youtubeLink = "https://youtu.be/dnFOM-0CClQ?feature=shared";
