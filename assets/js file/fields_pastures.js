...
let field_pastures = document.querySelector(".field_pastures");

window.addEventListener("load", () => {
  setTimeout(() => {
    preloader.style.display = "none";
    field_pastures.style.display = "flex";
  }, 1500);
});
...
image_container.addEventListener("click", () => {
  window.location.href = "the_milking.html";
});
...
center_part_bottom_btn.addEventListener("click", () => {
  let youtubeLink = "https://youtu.be/5MRfYXhEZAM?feature=shared";
